...
async function GET() {
    ...
    const { data, error } = await supabase.from("contact_groups").select("id, name, description, created_at").order("created_at", {
        ascending: false
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1162ee35._.js.map