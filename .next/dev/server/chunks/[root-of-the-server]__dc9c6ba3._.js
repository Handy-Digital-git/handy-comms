...
"[project]/src/app/api/tickets/status/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const { data: rows, error: fetchErr } = await supabase.from("contact_requests").select("ticket_no, submitted_by_email, phone, submitted_by_name, status, reason, amount_to_transfer, bank_customer_name").in("ticket_no", ticketNos);
        if (fetchErr) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const { error: updErr } = await supabase.from("contact_requests").update(updateObj).in("ticket_no", ticketNos);
        if (updErr) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (sgKey) __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sendgrid$2f$mail$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].setApiKey(sgKey);
        const twSid = process.env.TWILIO_ACCOUNT_SID;
        const twToken = process.env.TWILIO_AUTH_TOKEN;
        const twFrom = process.env.TWILIO_FROM; // verified Twilio number
        const twClient = twSid && twToken ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$twilio$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(twSid, twToken) : null;
        let emailCount = 0;
        let smsCount = 0;
        const sendOps = [];
        (rows ?? []).forEach((r)=>{
            const name = r.submitted_by_name || "there";
            const toEmail = r.submitted_by_email;
            const toPhone = normalizePhone(r.phone);
            const ticket = r.ticket_no;
            const reason = r.reason;
            const amount = r.amount_to_transfer;
            ...
            if (isBank && (status === "Sent" || status === "Incorrect Details")) {
                const bankNameRaw = r.bank_customer_name;
            ...
            if (isAgentPayIn && (status === "Clip Complete" || status === "Unable to Balance")) {
                if (status === "Clip Complete") {
                    ...
                    text = custom ? `Hello ${name},\n\n${custom}\n\nThanks,\nAdmin Team` : `Hello ${name},\n\nWe were unable to balance your clip. Please review and provide any missing details so we can assist further.\n\nThanks,\nAdmin Team`;
                }
            }
            if (sgKey && sgFrom && toEmail) {
                sendOps.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sendgrid$2f$mail$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].send({
                    to: toEmail,
                    from: sgFrom,
                    subject,
                    text
            ...
            if (twClient && twFrom && toPhone) {
                sendOps.push(twClient.messages.create({
                    from: twFrom,
                    to: toPhone,
                    body: text
                }).then(()=>smsCount++).catch(()=>{}));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dc9c6ba3._.js.map