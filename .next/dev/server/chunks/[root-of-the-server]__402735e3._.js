...
"[project]/src/app/api/contacts/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(_req, { params }) {
    try {
        ...
        const { data, error } = await supabase.from("contacts").update(updates).eq("id", id).select("id, name, phone, email, role, created_at").single();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__402735e3._.js.map