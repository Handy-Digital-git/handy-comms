...
"[project]/src/app/api/comms/send/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!message || contactIds.length === 0 && groupIds.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "message and at least one recipient are required"
            }, {
                status: 400
            });
        }
        ...
        if (Array.isArray(groupIds) && groupIds.length > 0) {
            const { data, error } = await supabase.from("contact_group_members").select("contact:contacts(id, name, phone), group_id").in("group_id", groupIds);
            if (error) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: error.message
            }, {
                status: 500
            });
            groupContacts.push(...(data ?? []).map((r)=>r.contact));
        }
        // Deduplicate by id
        const all = [
            ...directContacts,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5ee75d95._.js.map