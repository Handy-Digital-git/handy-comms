...
function ProtectedShell({ children, signOutAction }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProtectedShell.useEffect": ()=>{
            const supa = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
            const channel = supa.channel("public:contact_requests").on("postgres_changes", {
                event: "INSERT",
                schema: "public",
                table: "contact_requests"
            }, {
                "ProtectedShell.useEffect.channel": (payload)=>{
                    try {
            ...
            }["ProtectedShell.useEffect.channel"]).subscribe();
            return ({
                "ProtectedShell.useEffect": ()=>{
...
_s(ProtectedShell, "JL21BNDM2x26O0JWf0MP5o6pK9k=");
_c = ProtectedShell;
var _c;
...
//# sourceMappingURL=src_45773ba3._.js.map