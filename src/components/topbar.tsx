  ...
  return (
    <header className="sticky top-0 z-10 border-b border-border bg-bg backdrop-blur">
      <div className="mx-auto flex h-16 max-w-screen-2xl items-center gap-3 px-4">
        ...
        <button aria-label="Account" className="group relative ml-2 grid h-9 w-9 place-items-center rounded-full bg-card2" title="Account">
          <span role="tooltip" className="pointer-events-none absolute left-1/2 top-full z-10 mt-2 -translate-x-1/2 whitespace-nowrap rounded-md border border-border bg-card px-2 py-1 text-xs text-text opacity-0 shadow transition-all duration-150 group-hover:opacity-100">Account</span>
          <span className="pointer-events-none absolute left-1/2 top-full mt-[0.4rem] -translate-x-1/2 h-3 w-3 rotate-45 bg-card border-l border-t border-border opacity-0 transition-opacity duration-150 group-hover:opacity-100" />
        </button>
